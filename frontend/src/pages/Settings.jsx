...
const Settings = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    fuelPrice: user?.preferences?.fuelPrice || 1.50,
  ...
  const handleSubmit = async (e) => {
    ...
    const cleanData = {
      ...formData,
      fuelPrice: parseFloat(formData.fuelPrice) || 1.50,
    ...
    <div className="min-h-screen bg-white text-gray-900 selection:bg-gray-100 font-sans pb-32 animate-fade-in">
      ...
      <main className="max-w-5xl mx-auto px-6 py-4">
        <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
          ...
          {/* SECTION 1: Localization (Split Layout) */}
          <div className="py-12 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
            <div className="md:col-span-4">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-[15px] font-semibold text-gray-900 tracking-tight">Localization</h3>
              </div>
              <p className="text-[13px] text-gray-500 leading-relaxed pr-4">
                Define the primary currency for cost calculations and the metric system used for geographical distancing.
              </p>
            </div>
            ...
            <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="flex flex-col">
                ...
                <p className="text-[11px] text-gray-400 font-medium mt-2">Standard 3-letter ISO (e.g., USD, INR)</p>
              </div>
          ...
          {/* SECTION 2: Fleet Mechanics (Split Layout) */}
          <div className="py-12 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
            <div className="md:col-span-4">
              <div className="flex items-center mb-2">
                <Gauge className="w-4 h-4 mr-2 text-gray-900" strokeWidth={2} />
                <h3 className="text-[15px] font-semibold text-gray-900 tracking-tight">Fleet Mechanics</h3>
              </div>
              <p className="text-[13px] text-gray-500 leading-relaxed pr-4">
                Set baseline fuel costs and average vehicle consumption. These values drive the financial optimization metrics.
              </p>
            </div>
            ...
            <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="flex flex-col">
                ...
                <div className="relative flex items-center group">
                  <span className="absolute left-4 font-semibold text-gray-400 text-[13px] group-focus-within:text-gray-900 transition-colors">{currencySymbol}</span>
                  <input 
                    type="number" 
                    step="0.01"
                  ...
                  />
                  <span className="absolute right-4 text-[11px] font-semibold tracking-widest text-gray-400 uppercase border-l border-gray-200/80 pl-3">/ Ltr</span>
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="relative flex items-center group">
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, averageFuelConsumption: e.target.value})}
